...
// @desc delette a new task (admin only)
...
const updateTaskChecklist = async (req, res) => {
    ...
    try{
        ...
        //auto mar task as completed if all items are checked
...
const getUserDashboardData = async (req, res) => {
    ...
    try{
        ...
        const recentTasks = Task.find({ assignedTo: userId }).sort({ createdAt: -1 }).limit(10).select("title status priority dueDate createdAt");
